...
public class GrindingRecipe extends AbstractOreRefiningRecipe {
    public static final ResourceLocation TYPE_ID = new ResourceLocation(Scifix.MOD_ID, "grinding");
    public static final RecipeType<GrindingRecipe> TYPE = RecipeType.register(TYPE_ID.toString());

    public GrindingRecipe(ResourceLocation id, int rf, Ingredient input, ItemStack output, HashMap<ItemStack, Float> secondaryMap) {
    ...
    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<GrindingRecipe> {
        ...
        public GrindingRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new GrindingRecipe(id, rf, input, output, secondaryMap);
        }
